 ...
 */
//在vue-admin中 路由的状态是由子路由决定的，如果子路由有一个以上，那么该路由为嵌套路由
//
export const constantRoutes = [{
...

    {
        ...
        children: [{
            path: 'dashboard',
            name: 'Dashboard', //name属性应该要写，不写可能会出现一些不可预料的问题
            component: () =>
                import ('@/views/dashboard/index'),
            meta: { title: '花生二手车后台管理系统', icon: 'dashboard' }
        }],
    },
    //自定义一个模块 员工管理
    {
        ...
        children: [{
                ...
                name: 'Waiters',
                component: () =>
                    import ('@/views/waiters/index'),
                meta: { title: '员工管理', icon: 'form' }
            },
            {
                path: '/detail',
                component: () =>
                    import ('@/views/waiters/detail'),
                hidden: true
            },
        ]
    },
